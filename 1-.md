...
<p align="center">
  <img src="images/client-server.svg" alt="İstemci-Sunucu Mimarisi" width="500" />
  <br>
  <em>İstemci-Sunucu Mimarisi ve İstek/Yanıt (Request/Response) Döngüsü</em>
</p>
...
<p align="center">
  <img src="images/packet-switching.svg" alt="Paket Anahtarlama Mimarisi" width="600" />
  <br>
  <em>Paket anahtarlamalı ağlarda paketlerin bağımsız ve alternatif rotalar izlemesi</em>
</p>
...
<p align="center">
  <img src="images/tcp-ip.svg" alt="TCP/IP Veri Paketleme" width="500" />
  <br>
  <em>TCP ve IP katmanlarının veri paketlemedeki görev paylaşımı</em>
</p>
...
1989 yılında İsviçre Cenevre'deki Avrupa Nükleer Araştırma Merkezi'nde (CERN) çalışan İngiliz mühendis Tim Berners-Lee, akademik makalelerin ve bilgilerin sistemler arasında kaybolmasını önlemek için, bu bilgilerin "hipermetin" (hypertext) mantığıyla birbirine linklenerek bağlanabileceği bir ağ sistemi önerdi. 

<p align="center">
  <img src="images/tim-berners-lee.jpg" alt="Tim Berners-Lee" height="250" />
  <img src="images/first-web-server.jpg" alt="İlk Web Sunucusu (NeXT Computer)" height="250" />
  <br>
  <em>Tim Berners-Lee ve World Wide Web'i barındıran ilk web sunucusu (NeXT Computer). Kasa üzerindeki tarihi notta, temizlik görevlilerinin sistemi fişten çekmemeleri için "Bu makine bir sunucudur, KAPATMAYIN!!" yazmaktadır.</em>
</p>

Berners-Lee'nin icat ettiği World Wide Web, günümüzde de kullandığımız üç temel sac ayağı üzerine inşa edilmiştir:
