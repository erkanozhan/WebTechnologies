...
```svg
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 130" font-family="sans-serif" font-size="14">
  <!-- Birleştirilmiş başlık hücresi -->
  <rect x="1" y="1" width="478" height="35" fill="#2c3e50"/>
  <text x="240" y="24" text-anchor="middle" fill="#fff" font-weight="bold">Kırtasiye Stok Raporu</text>
  <!-- Sütun başlıkları -->
  <rect x="1" y="36" width="160" height="30" fill="#ecf0f1" stroke="#bdc3c7"/>
  <rect x="161" y="36" width="160" height="30" fill="#ecf0f1" stroke="#bdc3c7"/>
  <rect x="321" y="36" width="158" height="30" fill="#ecf0f1" stroke="#bdc3c7"/>
  <text x="81" y="56" text-anchor="middle" font-weight="bold">Ürün Adı</text>
  <text x="241" y="56" text-anchor="middle" font-weight="bold">Stok Miktarı</text>
  <text x="400" y="56" text-anchor="middle" font-weight="bold">Satış Miktarı</text>
  <!-- Veri satırı -->
  <rect x="1" y="66" width="160" height="30" fill="#fff" stroke="#bdc3c7"/>
  <rect x="161" y="66" width="160" height="30" fill="#fff" stroke="#bdc3c7"/>
  <rect x="321" y="66" width="158" height="30" fill="#fff" stroke="#bdc3c7"/>
  <text x="81" y="86" text-anchor="middle">Kalem</text>
  <text x="241" y="86" text-anchor="middle">114</text>
  <text x="400" y="86" text-anchor="middle">50</text>
  <!-- Dış çerçeve -->
  <rect x="1" y="1" width="478" height="95" fill="none" stroke="#2c3e50" stroke-width="1.5"/>
</svg>
```
...
```svg
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 95" font-family="sans-serif" font-size="14">
  <!-- Kırtasiye: rowspan=2, iki satırı kaplıyor -->
  <rect x="1" y="1" width="120" height="60" fill="#eaf2f8" stroke="#2c3e50" stroke-width="1.5"/>
  <text x="61" y="36" text-anchor="middle" font-weight="bold">Kırtasiye</text>
  <!-- Satır 1 verileri -->
  <rect x="121" y="1" width="120" height="30" fill="#fff" stroke="#bdc3c7"/>
  <rect x="241" y="1" width="118" height="30" fill="#fff" stroke="#bdc3c7"/>
  <text x="181" y="21" text-anchor="middle">Kalem</text>
  <text x="300" y="21" text-anchor="middle">114</text>
  <!-- Satır 2 verileri -->
  <rect x="121" y="31" width="120" height="30" fill="#fff" stroke="#bdc3c7"/>
  <rect x="241" y="31" width="118" height="30" fill="#fff" stroke="#bdc3c7"/>
  <text x="181" y="51" text-anchor="middle">Defter</text>
  <text x="300" y="51" text-anchor="middle">89</text>
  <!-- Dış çerçeve -->
  <rect x="1" y="1" width="358" height="60" fill="none" stroke="#2c3e50" stroke-width="1.5"/>
</svg>
```
